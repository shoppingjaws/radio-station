...
const parseDayWeek =(str)=>{
  switch (str) {
    ...
    case "FRI": return 5
    case "SAT": return 6
    default: throw new Error("Invalid dayweek",str)
  }
}
...
const radigo_input_s=`${targetDate.getFullYear()}${targetDate.getMonth()+1}${targetDate.getDate()}${String(input.rec_time_hour).padStart(2, '0')}${String(input.rec_time_min).padStart(2, '0')}`
